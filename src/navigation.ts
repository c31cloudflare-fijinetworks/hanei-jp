...
export const footerDataEn = {
  ...
  footNote: '<img src="/images/logo_main.png" class="inline-block h-4 w-auto mr-1.5 align-middle rounded-sm shadow-sm" /> © 2026. Hanei: Stunningly Beautiful English Marketing. All rights reserved.',
};
...
export const footerDataJp = {
  ...
  footNote: '<img src="/images/logo_main.png" class="inline-block h-4 w-auto mr-1.5 align-middle rounded-sm shadow-sm" /> © 2026. Hanei: Stunningly Beautiful English Marketing. 無断転載を禁じます。',
};
