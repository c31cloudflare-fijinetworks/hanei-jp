  ...
  links: [
    {
      ...
      links: [
        ...
        { text: 'Grand Reform', href: getPermalink('/grand-reform') },
        { text: 'Grand New Opening', href: getPermalink('/grand-new-opening') },
      ],
    },
  ...
  links: [
    {
      ...
      links: [
        ...
        { text: 'グランドリフォーム', href: getPermalink('/grand-reform-jp') },
        { text: 'グランド・ニューオープン', href: getPermalink('/grand-new-opening-jp') },
      ],
    },
